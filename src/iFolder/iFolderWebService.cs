...
public class iFolderWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    public virtual void RevertiFolder(string iFolderID) {
        this.Invoke("RevertiFolder", new object[] {
            iFolderID});
    }
    ...
    public virtual void EndRevertiFolder(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
