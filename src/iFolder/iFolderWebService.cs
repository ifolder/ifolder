...
public class iFolderWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    public virtual void RemoveSubscription(string DomainID, string SubscriptionID) {
        this.Invoke("RemoveSubscription", new object[] {
            DomainID,
            SubscriptionID});
    }

    public virtual System.IAsyncResult BeginRemoveSubscription(string DomainID, string SubscriptionID, System.AsyncCallback callback, object asyncState) {
