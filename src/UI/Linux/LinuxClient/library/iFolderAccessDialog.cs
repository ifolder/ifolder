...
namespace Novell.iFolder
{
	...
	public class iFolderAccessDialog : Dialog
	{
        ...
        /// <param name="rights">Access Rights</param>
        /// <param name="enableOwner">true to enable owner</param>
