...
extern __typeof (g_date_get_type) IA__g_date_get_type __attribute((visibility("hidden")));
#define g_date_get_type IA__g_date_get_type

extern __typeof (g_gstring_get_type) IA__g_gstring_get_type __attribute((visibility("hidden")));
#define g_gstring_get_type IA__g_gstring_get_type

extern __typeof (g_strv_get_type) IA__g_strv_get_type __attribute((visibility("hidden")));
#define g_strv_get_type IA__g_strv_get_type

extern __typeof (g_hash_table_get_type) IA__g_hash_table_get_type __attribute((visibility("hidden")));
#define g_hash_table_get_type IA__g_hash_table_get_type

extern __typeof (g_closure_get_type) IA__g_closure_get_type __attribute((visibility("hidden")));
#define g_closure_get_type IA__g_closure_get_type

extern __typeof (g_value_get_type) IA__g_value_get_type __attribute((visibility("hidden")));
#define g_value_get_type IA__g_value_get_type

extern __typeof (g_value_array_get_type) IA__g_value_array_get_type __attribute((visibility("hidden")));
...
extern __typeof (g_type_module_get_type) IA__g_type_module_get_type __attribute((visibility("hidden")));
...
extern __typeof (g_type_plugin_get_type) IA__g_type_plugin_get_type __attribute((visibility("hidden")));
