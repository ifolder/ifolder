...
****************************************************************************
*
* Program Name:      Storage Management Services SDAPI Error Codes
*
* Filename:          smssderr.h
*
...
* Modifications:	
*
* Comments:          Error numbers for SDAPIs
*                    Prefix:  FFFC
*
...
#define NWSMSD_ACCESS_DENIED            NWSMSD_ERROR_CODE(0xFFFF) 
   /* An attempt to read or write when that access was not  */
   /* granted                                               */
...
/* #define NWSMSD_INVALID_MESSAGE_NUMBER   NWSMSD_ERROR_CODE(0xFFF2) 
    Defined, below, was invalid message number                             
 */
