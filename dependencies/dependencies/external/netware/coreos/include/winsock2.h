...
//#define INADDR_BROADCAST        (u_long)0xffffffff //--present in BSD sock - kalis
 ...
 */
/*struct sockaddr_in { //--commented by kalis
        short   sin_family;
        u_short sin_port;
...
//#define SO_DONTLINGER   (int)(~SO_LINGER) --kalis
...
/*
 * Structure used for manipulating linger option. --commented by kalis
 */
//struct  linger {
