...
namespace Novell.FormsTrayApp
{
	...
	public class AcceptInvitation : System.Windows.Forms.Form
	{
        ...
        /// <summary>
        /// Convert iFolder rights to string
        /// </summary>
        /// <param name="rights">iFolder rights</param>
        ...
        /// <summary>
        /// Event handler for location text changed event
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
		...
		/// <summary>
		/// Event handler for Accept Invitation load event
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
        ...
        /// <summary>
        /// Event handler for Accept Invitation closing
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
