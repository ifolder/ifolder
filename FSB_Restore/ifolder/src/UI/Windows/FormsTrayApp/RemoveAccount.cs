...
{
	/// <summary>
	/// Summary description for RemoveAccount.
	/// </summary>
	public class RemoveAccount : System.Windows.Forms.Form
	{
		...
		#region Properties
		/// <summary>
		/// Gets a value indicating if the account is to be removed globally.
		/// </summary>
        ...
        /// <summary>
        /// Event Handler for removeall check box changed event
        /// </summary>
