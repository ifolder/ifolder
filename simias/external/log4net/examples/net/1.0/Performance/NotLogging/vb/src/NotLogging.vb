	...
	Public Class NotLogging 
		...
		Private Shared Function ProgramInit(Byval args As String()) As Integer 
			...
			Else If "true" = args(0) Then
				...
				CType(LogManager.GetLoggerRepository(), log4net.Repository.Hierarchy.Hierarchy).Threshold = log4net.spi.Level.WARN
			Else
				Usage()
			End If

			CType(SHORT_LOG.Logger, Logger).Level = log4net.spi.Level.INFO
			CType(LogManager.GetLoggerRepository(), log4net.Repository.Hierarchy.Hierarchy).Root.Level = log4net.spi.Level.INFO
