function updateMenu_myifolders() {
   ...
   if ((parent.theMenu) && (parent.theMenu.amBusy == false))
   {
     ...
     if ((level2ID != -1) && (parent.theMenu.entry[level2ID].FirstChild < 0))
      {
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Guidelines for Locating and Using iFolders", "../doc/user/data/locguide.html", "zHTML xD.0000.0000.0003.0001.", "Guidelines for Locating and Using iFolders");
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Setting an iFolder Quota", "../doc/user/data/ifquota.html", "zHTML xD.0000.0000.0003.0010.", "Setting an iFolder Quota");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Synchronizing Files", "../doc/user/data/sync.html", "zHTML xD.0000.0000.0003.0011.", "Synchronizing Files");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Resolving File Conflicts", "../doc/user/data/conflicts.html", "zHTML xD.0000.0000.0003.0012.", "Resolving File Conflicts");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Reverting an iFolder to a Normal Folder", "../doc/user/data/reverting.html", "zHTML xD.0000.0000.0003.0013.", "Reverting an iFolder to a Normal Folder");
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Deleting an iFolder", "../doc/user/data/deleting.html", "zHTML xD.0000.0000.0003.0015.", "Deleting an iFolder");
