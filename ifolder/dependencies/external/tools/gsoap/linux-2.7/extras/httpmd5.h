...
#define HTTP_MD5_ID "HTTP-MD5-1.0" /* plugin identification */

extern const char http_md5_id[];

enum http_md5_action { HTTP_MD5_INIT, HTTP_MD5_UPDATE, HTTP_MD5_FINAL, HTTP_MD5_DELETE };
...
{ int (*fposthdr)(struct soap*, const char*, const char*);
  ...
  int (*fhandler)(struct soap*, void **context, enum http_md5_action, char *buf, size_t len);
  void *context;
  char md5_digest[16];
};
