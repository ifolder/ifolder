...
function MIDraw (indentStr) {
	...
	if (useImages)
	{
		theImg = o.imgStore.getTag(this.docIconName(), 'docIcon' + this.id, tip);
	}
...
function initOutlineIcons(imgStore) {
	...
	imgStore.add('Folder', ip + 'folder.gif', 18, 18);
	imgStore.add('FolderMouseOver', ip + 'folder_mo.gif', 18, 18);
	imgStore.add('FolderExpanded', ip + 'folder_ex.gif', 18, 18);
	imgStore.add('FolderExpandedMouseOver', ip + 'folder_ex_mo.gif', 18, 18);
	imgStore.add('FolderExpandedSelected', ip + 'folder_ex_sel.gif', 18, 18);
	
	
	imgStore.add('Document', ip + 'doc.gif', 18, 18);
	imgStore.add('DocumentMouseOver', ip + 'doc_mo.gif', 18, 18);
