function updateMenu_accountsprefs() {
   ...
   if ((parent.theMenu) && (parent.theMenu.amBusy == false))
   {
     ...
     if ((level2ID != -1) && (parent.theMenu.entry[level2ID].FirstChild < 0))
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Configuring iFolder Preferences for the Client", "../doc/user/data/preferences.html", "zHTML xD.0000.0000.0002.0005.", "Configuring iFolder Preferences for the Client");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Configuring Local Firewall Settings for iFolder Traffic", "../doc/user/data/firewall.html", "zHTML xD.0000.0000.0002.0006.", "Configuring Local Firewall Settings for iFolder Traffic");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Configuring Local Virus Scanner Settings for iFolder Traffic", "../doc/user/data/virusscan.html", "zHTML xD.0000.0000.0002.0007.", "Configuring Local Virus Scanner Settings for iFolder Traffic");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Deleting an iFolder Account", "../doc/user/data/delacct.html", "zHTML xD.0000.0000.0002.0008.", "Deleting an iFolder Account");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Exiting the iFolder Client", "../doc/user/data/stopclient.html", "zHTML xD.0000.0000.0002.0009.", "Exiting the iFolder Client");
