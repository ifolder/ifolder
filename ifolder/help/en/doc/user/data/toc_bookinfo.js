function updateMenu_bookinfo() {
   ...
   if ((parent.theMenu) && (parent.theMenu.amBusy == false))
   {
     ...
     if (level1ID == -1)
      {
      level1ID = parent.theMenu.addChild(level0ID, "", "OES 2: Novell iFolder 3.6 Help", "../doc/user/data/bookinfo.html", "zFLDR xB.0000.0000.", "OES 2: Novell iFolder 3.6 Help");
      ...
      level2ID = parent.theMenu.addChild(level1ID, "Folder", "Novell iFolder Migration And Upgrade", "../doc/user/data/coexistmig.html", "zFLDR xC.0000.0000.0004.", "Novell iFolder Migration And Upgrade");
      parent.theMenu.entry[level2ID].FirstChild = -2;
