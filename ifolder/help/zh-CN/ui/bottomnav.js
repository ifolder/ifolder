...
{
self.document.writeln('  <a href="'+ prev_link + '" class="navigation"><img src="../../../ui/images/prev.gif" border=0 alt="上一页"></a>');
self.document.writeln('  <img src="../../../ui/images/virt_dot-line.gif" border="0" alt="">');
}
if (typeof next_link != 'undefined')
{
self.document.writeln('  <a href="'+ next_link + '" class="navigation"><img src="../../../ui/images/next.gif" border=0 alt="下一页"></a>');
