function updateMenu_front() {
   ...
   if ((parent.theMenu) && (parent.theMenu.amBusy == false))
   {
     ...
     if (level1ID == -1)
      {
      level1ID = parent.theMenu.addChild(level0ID, "", "iFolder 帮助", "../doc/user/data/front.html", "zFLDR xB.0000.0000.", "iFolder 帮助");
      level2ID = parent.theMenu.addChild(level1ID, "Folder", "iFolder 概述", "../doc/user/data/overview.html", "zFLDR xC.0000.0000.0001.", "iFolder 概述");
      ...
      level2ID = parent.theMenu.addChild(level1ID, "Folder", "管理 iFolder 帐户和自选设置", "../doc/user/data/accountsprefs.html", "zFLDR xC.0000.0000.0002.", "管理 iFolder 帐户和自选设置");
      parent.theMenu.entry[level2ID].FirstChild = -2;
      ...
      level2ID = parent.theMenu.addChild(level1ID, "Document", "法律声明", "../doc/user/data/legal.html", "zHTML xC.0000.0000.0004.", "法律声明");
