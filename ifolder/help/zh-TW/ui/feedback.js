...
self.document.writeln('  <img src="../../../ui/images/body_feedback.gif" border=0 alt="回饋"></a>');
self.document.writeln('  <img src="../../../ui/images/virt_dot-line.gif" border="0" alt="">');
self.document.writeln('  <a href="javascript:;" class="navigation" onClick="addtofav(window.location.href,document.title); return false"><img src="../../../ui/images/body_bookmark.gif" border=0 alt="將此頁設為書籤"></a>');