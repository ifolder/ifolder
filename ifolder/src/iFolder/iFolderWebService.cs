...
public class iFolderWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks>
    ///Remove a subscription for an iFolder
    ///</remarks>
    ...
    public virtual void RemoveSubscription(string iFolderID, string UserID) {
        this.Invoke("RemoveSubscription", new object[] {
            iFolderID,
            UserID});
    }

    public virtual System.IAsyncResult BeginRemoveSubscription(string iFolderID, string UserID, System.AsyncCallback callback, object asyncState) {
