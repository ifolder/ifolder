...
public class iFolderWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks>
    ///Sets the display iFolder confirmation setting
    ///</remarks>
    ...
    public virtual void SetDisplayConfirmation(bool DisplayConfirmation) {
        this.Invoke("SetDisplayConfirmation", new object[] {
            DisplayConfirmation});
    }

    public virtual System.IAsyncResult BeginSetDisplayConfirmation(bool DisplayConfirmation, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("SetDisplayConfirmation", new object[] {
            DisplayConfirmation}, callback, asyncState);
    }

    public virtual void EndSetDisplayConfirmation(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
    ...
    ///Get a subscription
    ///</remarks>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://novell.com/ifolder/web/GetSubscription",RequestNamespace="http://novell.com/ifolder/web/",ResponseNamespace="http://novell.com/ifolder/web/",ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped,Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    public virtual iFolder GetSubscription(string CollectionID, string NodeID) {
        System.Object[] results = this.Invoke("GetSubscription", new object[] {
            CollectionID,
            NodeID});
        return ((iFolder)(results[0]));
    }

    public virtual System.IAsyncResult BeginGetSubscription(string CollectionID, string NodeID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetSubscription", new object[] {
            CollectionID,
            NodeID}, callback, asyncState);
    }

    public virtual iFolder EndGetSubscription(System.IAsyncResult asyncResult) {
        System.Object[] results = this.EndInvoke(asyncResult);
        return ((iFolder)(results[0]));
    }
    ...
    /// <remarks>
    ///Revert an iFolder on the local computer but remain a member
    ///</remarks>
    ...
    public virtual iFolder RevertiFolder(string iFolderID) {
        System.Object[] results = this.Invoke("RevertiFolder", new object[] {
            iFolderID});
        return ((iFolder)(results[0]));
    }

    public virtual System.IAsyncResult BeginRevertiFolder(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("RevertiFolder", new object[] {
            iFolderID}, callback, asyncState);
    }

    public virtual iFolder EndRevertiFolder(System.IAsyncResult asyncResult) {
        System.Object[] results = this.EndInvoke(asyncResult);
        return ((iFolder)(results[0]));
    }
    ...
    public virtual void RemoveSubscription(string DomainID, string SubscriptionID, string UserID) {
    ...
    public virtual System.IAsyncResult BeginRemoveSubscription(string DomainID, string SubscriptionID, string UserID, System.AsyncCallback callback, object asyncState) {
    ...
    public virtual void EndRemoveSubscription(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
    ...
    /// <remarks>
    ///Search for a Member of a specified name.
    ///</remarks>
    ...
    public virtual iFolderUser[] SearchForiFolderUsers(string SearchString) {
        System.Object[] results = this.Invoke("SearchForiFolderUsers", new object[] {
            SearchString});
        return ((iFolderUser[])(results[0]));
    }

    public virtual System.IAsyncResult BeginSearchForiFolderUsers(string SearchString, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("SearchForiFolderUsers", new object[] {
            SearchString}, callback, asyncState);
    }

    public virtual iFolderUser[] EndSearchForiFolderUsers(System.IAsyncResult asyncResult) {
        System.Object[] results = this.EndInvoke(asyncResult);
        return ((iFolderUser[])(results[0]));
    }
    ...
    /// <remarks>
    ///Lookup a user in a collection based on node ID.
    ///</remarks>
    ...
    public virtual iFolderUser GetiFolderUserFromNodeID(string CollectionID, string NodeID) {
        System.Object[] results = this.Invoke("GetiFolderUserFromNodeID", new object[] {
            CollectionID,
            NodeID});
        return ((iFolderUser)(results[0]));
    }

    public virtual System.IAsyncResult BeginGetiFolderUserFromNodeID(string CollectionID, string NodeID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetiFolderUserFromNodeID", new object[] {
            CollectionID,
            NodeID}, callback, asyncState);
    }

    public virtual iFolderUser EndGetiFolderUserFromNodeID(System.IAsyncResult asyncResult) {
        System.Object[] results = this.EndInvoke(asyncResult);
        return ((iFolderUser)(results[0]));
    }
    ...
    /// <remarks>
    ///Sets the Disk Space Limit for an iFolder
    ///</remarks>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://novell.com/ifolder/web/SetiFolderDiskSpaceLimit",RequestNamespace="http://novell.com/ifolder/web/",ResponseNamespace="http://novell.com/ifolder/web/",ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped,Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    public virtual void SetiFolderDiskSpaceLimit(string iFolderID, long Limit) {
        this.Invoke("SetiFolderDiskSpaceLimit", new object[] {
            iFolderID,
            Limit});
    }

    public virtual System.IAsyncResult BeginSetiFolderDiskSpaceLimit(string iFolderID, long Limit, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("SetiFolderDiskSpaceLimit", new object[] {
            iFolderID,
            Limit}, callback, asyncState);
    }

    public virtual void EndSetiFolderDiskSpaceLimit(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
    ...
    public virtual Conflict[] GetiFolderConflicts(string iFolderID) {
        System.Object[] results = this.Invoke("GetiFolderConflicts", new object[] {
            iFolderID});
        return ((Conflict[])(results[0]));
    }

    public virtual System.IAsyncResult BeginGetiFolderConflicts(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetiFolderConflicts", new object[] {
            iFolderID}, callback, asyncState);
    }

    public virtual Conflict[] EndGetiFolderConflicts(System.IAsyncResult asyncResult) {
        System.Object[] results = this.EndInvoke(asyncResult);
        return ((Conflict[])(results[0]));
    }

    /// <remarks>
    ///Resolves a file conflict in an iFolder.
    ///</remarks>
    ...
    public virtual void ResolveFileConflict(string iFolderID, string conflictID, bool localChangesWin) {
    ...
    public virtual System.IAsyncResult BeginResolveFileConflict(string iFolderID, string conflictID, bool localChangesWin, System.AsyncCallback callback, object asyncState) {
    ...
    public virtual void EndResolveFileConflict(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }

    /// <remarks>
    ///Resolves a name conflict
    ///</remarks>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://novell.com/ifolder/web/ResolveNameConflict",RequestNamespace="http://novell.com/ifolder/web/",ResponseNamespace="http://novell.com/ifolder/web/",ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped,Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    public virtual void ResolveNameConflict(string iFolderID, string conflictID, string newLocalName) {
    ...
    public virtual System.IAsyncResult BeginResolveNameConflict(string iFolderID, string conflictID, string newLocalName, System.AsyncCallback callback, object asyncState) {
    ...
    public virtual void EndResolveNameConflict(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }

    /// <remarks>
    ///Sets up a proxy for iFolder to use
    ///</remarks>
    ...
    public virtual void SetupProxy(string Host, int Port) {
        this.Invoke("SetupProxy", new object[] {
            Host,
            Port});
    }

    public virtual System.IAsyncResult BeginSetupProxy(string Host, int Port, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("SetupProxy", new object[] {
            Host,
            Port}, callback, asyncState);
    }

    public virtual void EndSetupProxy(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
    ...
    public virtual System.IAsyncResult BeginRemoveProxy(System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("RemoveProxy", new object[0], callback, asyncState);
    }

    public virtual void EndRemoveProxy(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }

    /// <remarks>
    ///Calculates the number of nodes and bytes that need to be sync'd.
    ///</remarks>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://novell.com/ifolder/web/CalculateSyncSize",RequestNamespace="http://novell.com/ifolder/web/",ResponseNamespace="http://novell.com/ifolder/web/",ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped,Use=System.Web.Services.Description.SoapBindingUse.Literal)]
    public virtual SyncSize CalculateSyncSize(string iFolderID) {
        System.Object[] results = this.Invoke("CalculateSyncSize", new object[] {
            iFolderID});
        return ((SyncSize)(results[0]));
    }

    public virtual System.IAsyncResult BeginCalculateSyncSize(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("CalculateSyncSize", new object[] {
            iFolderID}, callback, asyncState);
    }

    public virtual SyncSize EndCalculateSyncSize(System.IAsyncResult asyncResult) {
        System.Object[] results = this.EndInvoke(asyncResult);
        return ((SyncSize)(results[0]));
    }

    /// <remarks>
    ///Sends a command to the sync engine to sync the iFolder of the specified ID.
    ///</remarks>
    ...
    public virtual void SynciFolderNow(string iFolderID) {
        this.Invoke("SynciFolderNow", new object[] {
            iFolderID});
    }

    public virtual System.IAsyncResult BeginSynciFolderNow(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("SynciFolderNow", new object[] {
            iFolderID}, callback, asyncState);
    }

    public virtual void EndSynciFolderNow(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
}
