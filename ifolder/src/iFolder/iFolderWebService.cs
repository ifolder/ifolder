...
public class iFolderWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetSubscription(string CollectionID, string NodeID, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public iFolder EndGetSubscription(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((iFolder)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginRevertiFolder(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("RevertiFolder", new object[] {
                    iFolderID}, callback, asyncState);
    }
    
    /// <remarks/>
    public iFolder EndRevertiFolder(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((iFolder)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetiFolderUserFromNodeID(string CollectionID, string NodeID, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public iFolderUser EndGetiFolderUserFromNodeID(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((iFolderUser)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginDeclineiFolderInvitation(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("DeclineiFolderInvitation", new object[] {
                    iFolderID}, callback, asyncState);
    }
    
    /// <remarks/>
    public void EndDeclineiFolderInvitation(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
