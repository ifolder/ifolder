...
public class iFolderWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks>
    ///Decline an invitation to an iFolder.  The iFolder ID represents a Subscription object
    ///</remarks>
    ...
    public virtual void DeclineiFolderInvitation(string iFolderID) {
        this.Invoke("DeclineiFolderInvitation", new object[] {
            iFolderID});
    }

    public virtual System.IAsyncResult BeginDeclineiFolderInvitation(string iFolderID, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("DeclineiFolderInvitation", new object[] {
            iFolderID}, callback, asyncState);
    }

    public virtual void EndDeclineiFolderInvitation(System.IAsyncResult asyncResult) {
        this.EndInvoke(asyncResult);
    }
