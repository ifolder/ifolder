...
namespace Novell.FormsTrayApp
{
	...
	public class ResetPassword : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.oldpassword.Text = "";// resources.GetString("passPhrase.Text");
            ...
            this.newPassword.Text = "";// resources.GetString("newPassphrase.Text");
            ...
            this.confirmPassword.Text = "";// resources.GetString("retypePassphrase.Text");
		...
		private void UpdateSensitivity()
		{
			if( this.oldpassword.Text.Length > 0 &&
				...
				this.btnReset.Enabled = false;
//				this.newPassword.Text == this.confirmPassword.Text &&
  //              this.newPassword.Text != this.oldpassword.Text)
		}
