...
namespace Novell.FormsTrayApp
{
	...
	public class iFoldersListView : System.Windows.Forms.UserControl
	{
        ...
        /// Update Quota in UI
        /// </summary>
        /// <param name="Qouta">iFolder DiskSpace Quota</param>
        public void updateqouta(string Qouta)
        {
            //this.richTextBox2.Text = string.Format(Resource.GetString("DiskSpace.Text") + Resource.GetString("Available.Text") + Qouta);
        ...
        /// <summary>
        /// Event Handler for iFolders List view CLick event
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for tile list view item selected index changed event
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for tile list view item removed event
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for tile list view item navigate event
        /// </summary>
...
//			}
        ...
        /// <summary>
        /// Gets / Sets the visible controls for ricktext box
        /// </summary>
