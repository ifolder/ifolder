...
namespace Novell.iFolderCom
{
	...
	public class NewiFolder : System.Windows.Forms.Form
	{
        ...
        /// <summary>
        /// Gets the Dont ask checked state
        /// </summary>
		public bool DontAsk
		{
			get
...
//			Win32Window.ShObjectProperties(IntPtr.Zero, SHOP_FILEPATH, FolderName, "iFolder");
		...
		/// <summary>
		/// Event Handler for new iFolder load
		/// </summary>
        ...
        /// <summary>
        /// Event handler for iFolder Overview link clicked
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for iFolder emblem paint
        /// </summary>
