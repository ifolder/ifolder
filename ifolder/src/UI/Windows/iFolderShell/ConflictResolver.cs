...
namespace Novell.iFolderCom
{
	...
	public class ConflictResolver : System.Windows.Forms.Form
	{
        ...
        /* Dummy constructor used in derived class -->EnhancedConflictResolver */
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="dummy">dummy value to initialize</param>
        ...
        /// <summary>
        /// Allocate Menu for all components
        /// </summary>
        ...
        /// </summary>
        /// <param name="resources">Resource Manager resource object</param>
        ...
        /// Format the label
        /// </summary>
        /// <param name="label">label which needs to be formatted</param>
        /// <param name="name">string to be formatted</param>
        ...
        /// Resolve confilcts
        /// </summary>
        /// <param name="localWins">local or server. true if local</param>
					...
					try
						{
							...
							else
							{
								...
								ifWebService.ResolveNameConflict(ifolder.ID, conflicts.ServerConflict.ConflictID, /*conflicts.ServerConflict.ServerName*/newName.Text);
							}
        ...
        /// <summary>
        /// Event Handler for Conflict Resolve
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for Conflict Resolver load
        /// </summary>
        /// <param name="sender">Object sender</param>
        /// <param name="e">Event</param>
        ...
        /// <summary>
        /// Event Handler when selected index is changed
        /// </summary>
        /// <param name="sender">Object sender</param>
        /// <param name="e">Event</param>
        ...
        /// <summary>
        /// Event Handler when Save local button is clicked.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler when Save Server button is clicked.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler when Name Resolver button is clicked
        /// </summary>
        ...
        /// <summary>
        /// Event Handler when name of the conlflict file is changed.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler when local name is double clicked.
        /// </summary>
		...
		/// <summary>
		/// Event Hnadler when server name is clicked.
		/// </summary>
        ...
        /// <summary>
        /// Event Handler when ifolder Path is painted
        /// </summary>
        ...
        /// <summary>
        /// Event Handler when local name is painted
        /// </summary>
		...
		/// <summary>
		/// Event Handler when close is clicked.
		/// </summary>
        ...
        /// <summary>
        /// Event Handler when size is changed.
        /// </summary>
