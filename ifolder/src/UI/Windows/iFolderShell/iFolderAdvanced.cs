...
namespace Novell.iFolderCom
{
	...
	public class iFolderAdvanced : System.Windows.Forms.Form
	{
        ...
        /// <summary>
        /// Cauluate the size of the widget
        /// </summary>
        /// <param name="control">Controls of the widget</param>
        /// <param name="delta">changes</param>
        /// <returns></returns>
        ...
        /// Node event
        /// </summary>
        /// <param name="ifolder">ifolder</param>
        /// <param name="ifolderUser">user of the iFolder</param>
        ...
        /// File Sync
        /// </summary>
        /// <param name="fileSyncEventArgs">Data of the file to be synced.</param>
        ...
        /// Sync Collection
        /// </summary>
        /// <param name="collectionSyncEventArgs"></param>
        ...
        /// <summary>
        /// Add the iFolder User to the view
        /// </summary>
        /// <param name="ifolderUser">iFolder User who is going to be added</param>
        /// <returns>The List view of users after adding</returns>
...
*/
			...
			setLimit.Visible = limitEdit.Visible = false; // User cannot set or change the quota even though he is the owner - #261517
            limitLabel.Visible = limit.Visible = !setLimit.Visible;

            //allow to change secure sync [ ssl ] if he is the owner
            this.ssl.Enabled = currentUser != null ? currentUser.UserID.Equals(currentiFolder.OwnerID) : false;
            
            //donot allow if https is configured , mandate ssl or ssl is configured.
        ...
        /// <summary>
        /// Convert the rights to string
        /// </summary>
        /// <param name="rights">Rights of iFolder User</param>
        /// <returns>Rights converted to string.</returns>
        ...
        /// Resize the button
        /// </summary>
        /// <param name="button">Button Controls</param>
        ...
        /// </summary>
        /// <param name="state">State of the sync </param>
        /// <param name="isOwner">true if owner else false</param>
        /// <returns>The Sync State converted to string value.</returns>
		...
		/// <summary>
		/// Update the selected items in list view
		/// </summary>
		/// <param name="rights">Rights of iFolder User</param>
		...
		/// </summary>
		/// <param name="lvi">List View Item which needs to be updated.</param>
        ...
        /// <summary>
        /// Event Handler for iFolderAdvanced load
        /// </summary>
...
//				conflictIcon.Image = new Icon(new Icon(Path.Combine(basePath, "ifolderconflict.ico")), 32, 32).ToBitmap();
        ...
        /// <summary>
        /// Event Handler for sharewith selected item changed
        /// </summary>
        ...
        /// <summary>
        /// Event handler for add button is clicked
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for remove button clciked.
        /// </summary>
...
*/		}
        ...
        /// <summary>
        /// Event Handler for decline button clicked
        /// </summary>
...
*/		}
        ...
        /// <summary>
        /// Event handler for apply button clicked.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for sutosync check box checked changed
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for sync interval value changed.
        /// </summary>
        ...
        /// <summary>
        /// Event handler for conflicts link clicked.
        /// </summary>
		...
		/// <summary>
		/// Event handler for Conflictresoover resolved.
		/// </summary>
        ...
        /// <summary>
        /// Limit Set check box checked changed.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for SSL check box checked changed.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for limit text changed.
        /// </summary>
	...
	*/
        /// <summary>
        /// Event Handler when Access button is clicked.
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for Share with mouse down
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for menu full control click
        /// </summary>
		...
		/// <summary>
		/// Event Handler for menu Read Write Click
		/// </summary>
        ...
        /// <summary>
        /// Event Handler for Menu read only click
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for share with Key down
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for tab control keydown
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for iFOlderAdvanced dialog paint
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for SyncNow button click
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for iFolderAdvanced dialog resize
        /// </summary>
        ...
        /// <summary>
        /// Event handler for Help buton click
        /// </summary>
        ...
        /// Verify Path
        /// </summary>
        /// <param name="exitingPath">string value - existing path</param>
        /// <param name="helpFile">file name</param>
        /// <returns>string - path to help file</returns>
        static public string veryfiyPath(string exitingPath, string helpFile)
        {
            ...
            {
                // Check if the path is present in application startup path...
                ...
                loadpath = loadpath.Substring(0, len2 - len - 1); /*Subtracting 1 for directory limiter*/
