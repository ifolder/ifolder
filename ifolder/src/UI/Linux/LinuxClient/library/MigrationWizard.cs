...
//			AccountDruid.CancelButton.Sensitive = false;
        ...
        /// <summary>
        /// Event Handler for Validate Clicked
        /// </summary>
...
//			AccountDruid.Forall(EnableFinishButtonCallback);
    ...
    /// COpy Directory
    /// </summary>
    /// <param name="source">Directory Info Source</param>
    /// <param name="destination">Diretory Info Destination</param>
    /// <returns>rue on success</returns>
	public static bool CopyDirectory(DirectoryInfo source, DirectoryInfo destination) 
	{
        ...
        /// <summary>
        /// Event Handler for Delete Button Changed event
        /// </summary>
        ...
        /// <summary>
        /// EVent Handler for Copy Checked Button changed
        /// </summary>
