...
*-----------------------------------------------------------------------------
  ...
  *         file chooser that uses GtkFileSelection or GtkFileChooser if it is available
  *
  *
  *******************************************************************************/
...
{
    /// <summary>
    /// class Compat File Chooser Dialog
    /// </summary>
...
//				use_file_chooser = false;
        ...
        /// <summary>
        /// Gets / Sets if mutiple objects can be selected
        /// </summary>
