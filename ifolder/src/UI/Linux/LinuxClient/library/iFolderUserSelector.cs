...
namespace Novell.iFolder
{
	...
	public class iFolderUserSelector : Dialog
	{
        ...
        /// <summary>
        /// Gets the list of Members with their Info
        /// </summary>
...
//			this.BorderWidth = 10;
        ...
        /// <summary>
        /// Event Handler for Member Index Selected
        /// </summary>
        ...
        /// <summary>
        /// Event Handler for Member Index acyivated
        /// </summary>
	...
	internal class MemberListModel : IListModel
	{
        ...
        /// <param name="MemberList">Member List</param>
