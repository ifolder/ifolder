...
//		private iFolderConflictDialog 	ConflictDialog;
		...
		private iFolderPropUnsynchronizedPage UnsynchronizedPage;
...
//			ifHash = new Hashtable();
		...
		public void UpdateiFolder(iFolderWeb theiFolder)
		{
			...
			UnsynchronizedPage.UpdateiFolder(theiFolder);
		}
...
//			dialogBox.PackStart(ConflictHolder, false, true, 0);
			...
			UnsynchronizedPage = new iFolderPropUnsynchronizedPage(this, ifws, simws);
			
			propNoteBook.AppendPage(UnsynchronizedPage,
								new Label(Util.GS("Unsynchronized Files")));
