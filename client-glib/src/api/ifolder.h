 ...
 */
typedef enum _iFolderMemberRights
{
 ...
 */
IFOLDER_API iFolderType ifolder_get_type(const iFolder ifolder);
 ...
 * @return IFOLDER_SUCCESS if the call was successful.
 */
IFOLDER_API int ifolder_start_synchronization(const iFolder ifolder, bool sync_now = false);
 ...
 * @return IFOLDER_SUCCESS if the call was successful.
 */
IFOLDER_API int ifolder_resume_synchronization(const iFolder ifolder, bool sync_now = false);
