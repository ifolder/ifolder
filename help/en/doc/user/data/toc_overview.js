function updateMenu_overview() {
   ...
   if ((parent.theMenu) && (parent.theMenu.amBusy == false))
   {
     ...
     if ((level2ID != -1) && (parent.theMenu.entry[level2ID].FirstChild < 0))
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Benefits of iFolder", "../doc/user/data/benefits.html", "zHTML xD.0000.0000.0001.0002.", "Benefits of iFolder");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Key Features of iFolder", "../doc/user/data/keyfeatures.html", "zHTML xD.0000.0000.0001.0003.", "Key Features of iFolder");
