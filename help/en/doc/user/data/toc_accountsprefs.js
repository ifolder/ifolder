function updateMenu_accountsprefs() {
   ...
   if ((parent.theMenu) && (parent.theMenu.amBusy == false))
   {
     ...
     if ((level2ID != -1) && (parent.theMenu.entry[level2ID].FirstChild < 0))
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Stopping the iFolder Client", "../doc/user/data/b41jzxm.html", "zHTML xD.0000.0000.0002.0002.", "Stopping the iFolder Client");
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Logging Out of an iFolder Account", "../doc/user/data/b41lzuy.html", "zHTML xD.0000.0000.0002.0005.", "Logging Out of an iFolder Account");
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Deleting an iFolder Account", "../doc/user/data/bvwsp7c.html", "zHTML xD.0000.0000.0002.0007.", "Deleting an iFolder Account");
      ...
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Configuring Local Firewall Settings for iFolder Traffic", "../doc/user/data/bvwppw5.html", "zHTML xD.0000.0000.0002.0009.", "Configuring Local Firewall Settings for iFolder Traffic");
      level3ID = parent.theMenu.addChild(level2ID, "Document", "Configuring Local Virus Scanner Settings for iFolder Traffic", "../doc/user/data/bwbirb9.html", "zHTML xD.0000.0000.0002.0010.", "Configuring Local Virus Scanner Settings for iFolder Traffic");
