...
{
self.document.writeln('  <a href="'+ prev_link + '" class="navigation"><img src="../../../docui2002/images/prev.gif" border=0 alt="Предыдущая"></a>');
self.document.writeln('  <img src="../../../docui2002/images/virt_dot-line.gif" border="0" alt="">');
}
if (typeof next_link != 'undefined')
{
self.document.writeln('  <a href="'+ next_link + '" class="navigation"><img src="../../../docui2002/images/next.gif" border=0 alt="Следующая"></a>');
}
