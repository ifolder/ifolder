...
self.document.writeln('  <a href="javascript:;" class="navigation" onClick="addtofav(window.location.href,document.title); return false"><img src="../../../ui/images/body_bookmark.gif" border=0 alt="Bookmark this page"></a>');
