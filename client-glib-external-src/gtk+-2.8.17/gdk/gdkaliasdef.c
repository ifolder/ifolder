...
#undef gdk_screen_set_font_options_libgtk_only 
extern __typeof (gdk_screen_set_font_options_libgtk_only) gdk_screen_set_font_options_libgtk_only __attribute((alias("IA__gdk_screen_set_font_options_libgtk_only"), visibility("default")));

#undef gdk_screen_get_font_options_libgtk_only 
extern __typeof (gdk_screen_get_font_options_libgtk_only) gdk_screen_get_font_options_libgtk_only __attribute((alias("IA__gdk_screen_get_font_options_libgtk_only"), visibility("default")));

#undef gdk_screen_set_resolution_libgtk_only 
extern __typeof (gdk_screen_set_resolution_libgtk_only) gdk_screen_set_resolution_libgtk_only __attribute((alias("IA__gdk_screen_set_resolution_libgtk_only"), visibility("default")));

#undef gdk_screen_get_resolution_libgtk_only 
extern __typeof (gdk_screen_get_resolution_libgtk_only) gdk_screen_get_resolution_libgtk_only __attribute((alias("IA__gdk_screen_get_resolution_libgtk_only"), visibility("default")));
